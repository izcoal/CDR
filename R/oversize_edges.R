...
#'
#' @format Oversize_edges.csv es un data.table con 248 filas y 2 columnas. La primera fila es el encabezado que contiene el nombre de las variables:
#' \describe{
#'   \item{from}{int Origen de la arista.}
#'   \item{to}{int Destino de la arista}
#' }
#' @usage Oversize_edges
