#' Resultados electorales en Andalucia
#'
#' @format Un tibble de 113.161 filas y 13 variables:
#' \describe{
#'   \item{convocatoria}{Date Fecha de la convocatoria electoral}
...
#'   \item{codigo_num}{chr ...}
#'   \item{bloque}{chr Orientación politica del bloque ganador}
#' }
#' @description Resultados electorales en las elecciones de Andalucía
