...
#'   \item{t_bus_e}{chr ordered factor Tiempo que el parado lleva buscando empleo (tiempo desde la última inscripción en el paro).}
#'   \item{tramo_edad}{chr ordered factor Tramo de edad del parado. Valores: "Menor de 30 años", "Desde 30 a 44 años", "De 45 años o más"}
#'   \item{t_bus_e_agr}{chr ordered factor Tiempo que el parado lleva buscando empleo (tiempo desde la última inscripción en el paro). }
